				...
				},
				{
					...
					children: [
						...
						onChange: function() {
							...
							init_value = init_value.replace("hidden-xs","");
							
							if(this.getValue() === true){
								init_value += " hidden-xs ";
							}
							dialog.setValueOf( 'advanced', 'txtGenClass', init_value );
						},
						setup: function(a, b) {
							class_string = b.getAttribute("class");
							flag = false;
							if(class_string.indexOf("hidden-xs") > -1){
								flag = true;
							}
						
							1 == a && this.setValue(flag)
						}
					},
					
					{
						...
						onChange: function() {
							...
							dialog = this.getDialog();
							init_value = dialog.getValueOf( 'advanced', 'txtGenClass');
							init_value = init_value.replace("hidden-sm","");
							
							if(this.getValue() === true){
								init_value += " hidden-sm ";
							}
							dialog.setValueOf( 'advanced', 'txtGenClass', init_value );
						},
						setup: function(a, b) {
							class_string = b.getAttribute("class");
							flag = false;
							if(class_string.indexOf("hidden-sm") > -1){
								flag = true;
							}
					...
					
					{
						...
						onChange: function() {
							...
							dialog = this.getDialog();
							init_value = dialog.getValueOf( 'advanced', 'txtGenClass');
							init_value = init_value.replace("hidden-md","");
							
							if(this.getValue() === true){
								init_value += " hidden-md ";
							}
							dialog.setValueOf( 'advanced', 'txtGenClass', init_value );
						},
						setup: function(a, b) {
							class_string = b.getAttribute("class");
							flag = false;
							if(class_string.indexOf("hidden-md") > -1){
								flag = true;
							}
					...
					},
					{
						...
						onChange: function() {
							...
							dialog = this.getDialog();
							init_value = dialog.getValueOf( 'advanced', 'txtGenClass');
							init_value = init_value.replace("hidden-lg","");
							
							if(this.getValue() === true){
								init_value += " hidden-lg ";
							}
							dialog.setValueOf( 'advanced', 'txtGenClass', init_value );
						},
						setup: function(a, b) {
							class_string = b.getAttribute("class");
							flag = false;
							if(class_string.indexOf("hidden-lg") > -1){
								flag = true;
							}
