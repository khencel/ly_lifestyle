...
<?php if(!$not_avail) { ?>
    ...
    <div class="form-group<?= ($option['required'] ? ' required' : ''); ?>">
      <div class="row">
          <div class="col-md-3 col-sm-12 option-cont">
            <label class="control-label" for="input-option<?= $option['product_option_id']; ?>"><?= $option['name']; ?></label>
          </div>
          <div class="col-md-9 col-sm-12">
               <select name="option[<?= $option['product_option_id']; ?>]" id="input-option<?= $option['product_option_id']; ?>" class="form-control option-style">
...
<?php } ?>
    ...
    <div class="form-group">
        <?php if(!$not_avail) { ?>
         <div class="row">
            <div class="col-md-3 col-sm-12 option-cont">
               <span class="control-label"><?= $entry_qty; ?></span>
            </div>
            <div class="col-md-9 col-sm-12">
    ...
    <?php } ?>
      ...
      <?php if(!$enquiry){ ?>
        ...
        <div class="add-cart-cont">
            <button type="button" id="button-cart" data-loading-text="<?= $text_loading; ?>" class="custom-button add-cart-button"><?= $button_cart; ?></button>
            <button type="button" id="button-cancel" data-loading-text="<?= $text_loading; ?>" class="custom-button add-cart-button" style="background-color:#D7D7D7"><?= $button_back; ?></button>
        </div>
        <?php } ?>
      <?php }else{ ?>
