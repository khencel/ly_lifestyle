...
<div class="my-cont">
	...
	<div id="content" class="<?= $class; ?>">
		<div class="head_label head_label1">Products</div>
		...
		<div class="row">
			...
			<?php } ?>
			<div class="<?= $class; ?>" style="position:relative;padding:0px !important">
				<?php if ($vertical_slider) { ?>
						<?php include_once('product_image_vertical.tpl'); ?>
				<?php } else { ?>
					<img src="image/catalog/product_inner/floater.png" class="img-responsive product-background"/>
			...
			<div class="<?= $class; ?>" >
				<div class="desc-cont"><?= $heading_title; ?></div>
...
<style>
	...
	#pg-banner-wrap{
		padding-top:11%;
		background-image: url('image/catalog/general/bg-min.png');
